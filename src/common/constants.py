...
ERR_START_MSG = "Unable to start the MariaDB database."
...
ERR_INVALID_BINARY_ACTION = "mysql was not found under the provided installation directory \n" \
    "Please verify the MariaDB directory and retry the operation."

ERR_MYCNF_MSG = "MariaDB configuration file (my.cnf) not found on host."
ERR_MYCNF_ACTION = "Please provide a my.cnf file in the Delphix Toolkit folder on host."

ERR_PWD_MSG = "An error occurred while changing password for the MariaDB Staging database."
...
ERR_CONNECT_MSG = "Unable to connect to MariaDB database."
ERR_CONNECT_ACTION = "Please verify and confirm that " \
    "1. The DB username and password are accurate " \
    "2. The MariaDB Database is running on the Host. " \
...
ERR_GENERAL_MSG = "An error occurred while provisioning the MariaDB VDB."
ERR_GENERAL_ACTION = "This could be due to an unsupported version of MariaDB."
